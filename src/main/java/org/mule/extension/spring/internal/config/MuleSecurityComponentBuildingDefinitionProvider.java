...
import static org.mule.extension.spring.internal.config.SpringXmlNamespaceInfoProvider.MULE_SS_NAMESPACE;
...
/**
 * {@link ComponentBuildingDefinition} definitions for the components provided by the mule spring security module.
 *
 * @since 1.0
 */
